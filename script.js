...
const openModal = function(e) {
    e.preventDefault()
    let galery = document.querySelector(".galerie-image");
    nettoyage(galery);
    listeProjetModal(0);
...
function displayImages(image) {
    ...
    images = `<div class="image">
                ...
                <span id="delImg">&times;</span>
              </div>`;

    output.innerHTML = images
    let delImg = document.querySelector("#delImg");
    delImg.addEventListener("click", deleteImage());
}
...
form.addEventListener("submit", function(e) {
    ...
    let formData = new FormData(form); N     
